...
public class DriverFactory {
    ...
    public static final String LOCAL_GRID_URL = "localhost:4444/wd/hub";
    ...
    public static DriverFactory getInstance(String browserName)
    {
        ...
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            //System.setProperty("webdriver.chrome.driver",System.getProperty("C:/MyDevelopments/BDDSeleniumReferenceSSNB4.3/src/main/resources/grid/chromedriver.exe"));
